...
model = Word2Vec(window = 5, sg = 1, hs = 0, vector_size=20,
...
model.add(Conv1D(32, kernel_size=(10), input_shape=(696,1), activation='relu')) # Input based on the X_train_np dimension
...
# model.add(Dropout(0.2))
model.add(Dense(2727,kernel_initializer='normal',activation='softmax')) # Output based on the Y_train_np dimension
